...
import com.rawchen.model.dto.Comment;
...
public class CommentController {
	...
	public Result postComment(@RequestBody Comment comment,
		...
		//父评论
		com.rawchen.entity.Comment parentComment = null;
	 ...
	 */
	private void judgeSendMail(Comment comment, boolean isVisitorComment, com.rawchen.entity.Comment parentComment) {
	 ...
	 * @param comment       当前评论
	 */
	private void sendMailToParentComment(com.rawchen.entity.Comment parentComment, Comment comment) {
		String path = "";
		String title = "";
		if (comment.getPage() == 0) {
			//普通博客

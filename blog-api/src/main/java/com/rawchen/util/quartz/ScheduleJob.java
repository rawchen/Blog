...
public class ScheduleJob extends QuartzJobBean {
	...
	protected void executeInternal(JobExecutionContext context) {
		com.rawchen.entity.ScheduleJob scheduleJob = (com.rawchen.entity.ScheduleJob) context.getMergedJobDataMap().get(com.rawchen.entity.ScheduleJob.JOB_PARAM_KEY);
		//获取spring bean

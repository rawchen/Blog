...
import com.yoyling.util.common.SpringContextUtils;
import lombok.extern.slf4j.Slf4j;
import org.quartz.JobExecutionContext;
import org.springframework.scheduling.quartz.QuartzJobBean;
import com.yoyling.entity.ScheduleJobLog;
import com.yoyling.service.ScheduleJobService;
...
public class ScheduleJob extends QuartzJobBean {
	...
	protected void executeInternal(JobExecutionContext context) {
		com.yoyling.entity.ScheduleJob scheduleJob = (com.yoyling.entity.ScheduleJob) context.getMergedJobDataMap().get(com.yoyling.entity.ScheduleJob.JOB_PARAM_KEY);
		//获取spring bean
